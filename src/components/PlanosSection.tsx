      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16 text-center">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <p className="font-montserrat text-sm font-bold text-primary uppercase tracking-wider mb-2">Price per robot</p>
            <p className="font-opensans text-sm text-muted leading-relaxed">Each strategy is licensed individually per MT5 account. You choose the asset and the plan that best fits your profile.</p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <p className="font-montserrat text-sm font-bold text-primary uppercase tracking-wider mb-2">Ongoing support</p>
            <p className="font-opensans text-sm text-muted leading-relaxed">All plans include WhatsApp support, periodic updates and follow-up throughout the entire contract.</p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <p className="font-montserrat text-sm font-bold text-primary uppercase tracking-wider mb-2">Brazil Partnership</p>
            <p className="font-opensans text-sm text-muted leading-relaxed">Exclusive plan for the Brazilian market. No monthly fee — you only pay a commission on the profit generated by the robot.</p>
          </div>
        </div>
        <div className="flex flex-wrap justify-center gap-8">
          <div className="flex-1 min-w-[200px] max-w-[240px] rounded-2xl overflow-hidden hover:-translate-y-2 transition-transform duration-200 cursor-pointer">
            <div className="bg-[#1a5fa8] px-5 py-4 text-center">
              <p className="font-montserrat font-bold text-white text-base">Semiannual</p>
            </div>
          ...
          <div className="flex-1 min-w-[200px] max-w-[240px] rounded-2xl overflow-hidden hover:-translate-y-2 transition-transform duration-200 cursor-pointer">
            ...
            <div className="bg-[#9f5ff0] px-5 py-6 flex flex-col gap-4" style={{boxShadow:'0 6px 0 #4c1d95',borderRadius:'0 0 16px 16px'}}>
              <div className="text-center">
                ...
                <p className="font-opensans text-white/70 text-xs mt-1">monthly fee · pay only on profit</p>
              </div>
              <div className="border-t border-white/20 pt-4 flex flex-col gap-2">
