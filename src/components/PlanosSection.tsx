        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="flex-1 min-w-[200px] max-w-[240px] rounded-2xl overflow-hidden hover:-translate-y-2 transition-transform duration-200 cursor-pointer">
            ...
            <div className="bg-[#5aaa2a] px-5 py-6 flex flex-col gap-4" style={{boxShadow:'0 6px 0 #1f5010',borderRadius:'0 0 16px 16px'}}>
              ...
              <a href="https://wa.me/55SEUNUMERO" target="_blank" rel="noopener noreferrer" className="mt-2 block text-center bg-white/20 hover:bg-white/30 border border-white/40 text-white font-montserrat font-bold text-sm py-2.5 rounded-xl transition-all">
                Falar no WhatsApp ↗
              </a>
            </div>
          </div>
