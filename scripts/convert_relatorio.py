...
def converter(html_path, output_dir):
    ...
    output_path = os.path.join(output_dir, nome_html + '.json')
    ...
    print("Convertido: " + html_path + " -> " + output_path)
    print("Operacoes: " + str(len(pares)) + " | Lucro: $" + str(lucro) + " | Win rate: " + str(win_rate) + "%")
